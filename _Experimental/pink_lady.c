    ...
    if (pink_lady_manager_tab[var->spi_id][id].status != PL_SEGMENT_FINISHED)
    {
        ...
        switch (pink_lady_manager_tab[var->spi_id][id].sm.index)
        {
            ...
            case 4: // Deadline_to_appear > 0 (part 1: led update)
                ...
                pink_lady_manager_tab[var->spi_id][id].p_led[*pink_lady_manager_tab[var->spi_id][id].p_ind_red].red    = (uint8_t) (((*pink_lady_manager_tab[var->spi_id][id].p_ind_red % resolution) > 0) ? 0 : (uint32_t)(pink_lady_manager_tab[var->spi_id][id].p_led_copy[*pink_lady_manager_tab[var->spi_id][id].p_ind_red].red + (*pink_lady_manager_tab[var->spi_id][id].p_lowest_value_red + (pink_lady_manager_tab[var->spi_id][id].ind_ * pink_lady_manager_tab[var->spi_id][id].delta_color.red / pink_lady_manager_tab[var->spi_id][id].number_of_led) - pink_lady_manager_tab[var->spi_id][id].p_led_copy[*pink_lady_manager_tab[var->spi_id][id].p_ind_red].red) * pink_lady_manager_tab[var->spi_id][id].intensity / 100));
                ...
                pink_lady_manager_tab[var->spi_id][id].p_led[*pink_lady_manager_tab[var->spi_id][id].p_ind_blue].blue   = (uint8_t) (((*pink_lady_manager_tab[var->spi_id][id].p_ind_blue % resolution) > 0) ? 0 : (uint32_t)(pink_lady_manager_tab[var->spi_id][id].p_led_copy[*pink_lady_manager_tab[var->spi_id][id].p_ind_blue].blue + (*pink_lady_manager_tab[var->spi_id][id].p_lowest_value_blue + (pink_lady_manager_tab[var->spi_id][id].ind_ * pink_lady_manager_tab[var->spi_id][id].delta_color.blue / pink_lady_manager_tab[var->spi_id][id].number_of_led) - pink_lady_manager_tab[var->spi_id][id].p_led_copy[*pink_lady_manager_tab[var->spi_id][id].p_ind_blue].blue) * pink_lady_manager_tab[var->spi_id][id].intensity / 100));
                pink_lady_manager_tab[var->spi_id][id].p_led[*pink_lady_manager_tab[var->spi_id][id].p_ind_white].white  = (uint8_t) (((*pink_lady_manager_tab[var->spi_id][id].p_ind_white % resolution) > 0) ? 0 : (uint32_t)(pink_lady_manager_tab[var->spi_id][id].p_led_copy[*pink_lady_manager_tab[var->spi_id][id].p_ind_white].white + (*pink_lady_manager_tab[var->spi_id][id].p_lowest_value_white + (pink_lady_manager_tab[var->spi_id][id].ind_ * pink_lady_manager_tab[var->spi_id][id].delta_color.white / pink_lady_manager_tab[var->spi_id][id].number_of_led) - pink_lady_manager_tab[var->spi_id][id].p_led_copy[*pink_lady_manager_tab[var->spi_id][id].p_ind_white].white) * pink_lady_manager_tab[var->spi_id][id].intensity / 100));
