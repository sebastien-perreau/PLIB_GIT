...
{
    buffer[0] = ((var->p_registers[device_index].phase[0] >> 2) & 0xff);
    buffer[1] = ((var->p_registers[device_index].phase[1] >> 2) & 0xff);
    buffer[2] = ((var->p_registers[device_index].phase[2] >> 2) & 0xff);
    buffer[3] = ((var->p_registers[device_index].phase[3] >> 2) & 0xff);
    buffer[4] = ((var->p_registers[device_index].phase[4] >> 2) & 0xff);
    buffer[5] = ((var->p_registers[device_index].phase[5] >> 2) & 0xff);
    buffer[6] = ((var->p_registers[device_index].phase[6] >> 2) & 0xff);
    buffer[7] = ((var->p_registers[device_index].phase[7] >> 2) & 0xff);
    buffer[8] = ((var->p_registers[device_index].phase[8] >> 2) & 0xff);
    buffer[9] = ((var->p_registers[device_index].phase[9] >> 2) & 0xff);
    buffer[10] = ((var->p_registers[device_index].phase[10] >> 2) & 0xff);
    buffer[11] = ((var->p_registers[device_index].phase[11] >> 2) & 0xff);

    buffer[12] = ((var->p_registers[device_index].phase[0] & 0x03) << 0) | ((var->p_registers[device_index].phase[1] & 0x03) << 2) | ((var->p_registers[device_index].phase[2] & 0x03) << 4);
    buffer[13] = ((var->p_registers[device_index].phase[3] & 0x03) << 0) | ((var->p_registers[device_index].phase[4] & 0x03) << 2) | ((var->p_registers[device_index].phase[5] & 0x03) << 4);
    buffer[14] = ((var->p_registers[device_index].phase[6] & 0x03) << 0) | ((var->p_registers[device_index].phase[7] & 0x03) << 2) | ((var->p_registers[device_index].phase[8] & 0x03) << 4);
    buffer[15] = ((var->p_registers[device_index].phase[9] & 0x03) << 0) | ((var->p_registers[device_index].phase[10] & 0x03) << 2) | ((var->p_registers[device_index].phase[11] & 0x03) << 4);  
    
    buffer[16] = ((var->p_registers[device_index].width[0] >> 2) & 0xff);
    buffer[17] = ((var->p_registers[device_index].width[1] >> 2) & 0xff);
    buffer[18] = ((var->p_registers[device_index].width[2] >> 2) & 0xff);
    buffer[19] = ((var->p_registers[device_index].width[3] >> 2) & 0xff);
    buffer[20] = ((var->p_registers[device_index].width[4] >> 2) & 0xff);
    buffer[21] = ((var->p_registers[device_index].width[5] >> 2) & 0xff);
    buffer[22] = ((var->p_registers[device_index].width[6] >> 2) & 0xff);
    buffer[23] = ((var->p_registers[device_index].width[7] >> 2) & 0xff);
    buffer[24] = ((var->p_registers[device_index].width[8] >> 2) & 0xff);
    buffer[25] = ((var->p_registers[device_index].width[9] >> 2) & 0xff);
    buffer[26] = ((var->p_registers[device_index].width[10] >> 2) & 0xff);
    buffer[27] = ((var->p_registers[device_index].width[11] >> 2) & 0xff);

    buffer[28] = ((var->p_registers[device_index].width[0] & 0x03) << 0) | ((var->p_registers[device_index].width[1] & 0x03) << 2) | ((var->p_registers[device_index].width[2] & 0x03) << 4);
    buffer[29] = ((var->p_registers[device_index].width[3] & 0x03) << 0) | ((var->p_registers[device_index].width[4] & 0x03) << 2) | ((var->p_registers[device_index].width[5] & 0x03) << 4);
    buffer[30] = ((var->p_registers[device_index].width[6] & 0x03) << 0) | ((var->p_registers[device_index].width[7] & 0x03) << 2) | ((var->p_registers[device_index].width[8] & 0x03) << 4);
    buffer[31] = ((var->p_registers[device_index].width[9] & 0x03) << 0) | ((var->p_registers[device_index].width[10] & 0x03) << 2) | ((var->p_registers[device_index].width[11] & 0x03) << 4);    
}
...
{
    buffer[0] = ((var->p_registers[device_index].width[0] >> 2) & 0xff);
    buffer[1] = ((var->p_registers[device_index].width[1] >> 2) & 0xff);
    buffer[2] = ((var->p_registers[device_index].width[2] >> 2) & 0xff);
    buffer[3] = ((var->p_registers[device_index].width[3] >> 2) & 0xff);
    buffer[4] = ((var->p_registers[device_index].width[4] >> 2) & 0xff);
    buffer[5] = ((var->p_registers[device_index].width[5] >> 2) & 0xff);
    buffer[6] = ((var->p_registers[device_index].width[6] >> 2) & 0xff);
    buffer[7] = ((var->p_registers[device_index].width[7] >> 2) & 0xff);
    buffer[8] = ((var->p_registers[device_index].width[8] >> 2) & 0xff);
    buffer[9] = ((var->p_registers[device_index].width[9] >> 2) & 0xff);
    buffer[10] = ((var->p_registers[device_index].width[10] >> 2) & 0xff);
    buffer[11] = ((var->p_registers[device_index].width[11] >> 2) & 0xff);

    buffer[12] = ((var->p_registers[device_index].width[0] & 0x03) << 0) | ((var->p_registers[device_index].width[1] & 0x03) << 2) | ((var->p_registers[device_index].width[2] & 0x03) << 4);
    buffer[13] = ((var->p_registers[device_index].width[3] & 0x03) << 0) | ((var->p_registers[device_index].width[4] & 0x03) << 2) | ((var->p_registers[device_index].width[5] & 0x03) << 4);
    buffer[14] = ((var->p_registers[device_index].width[6] & 0x03) << 0) | ((var->p_registers[device_index].width[7] & 0x03) << 2) | ((var->p_registers[device_index].width[8] & 0x03) << 4);
    buffer[15] = ((var->p_registers[device_index].width[9] & 0x03) << 0) | ((var->p_registers[device_index].width[10] & 0x03) << 2) | ((var->p_registers[device_index].width[11] & 0x03) << 4);    
}
    ...
    switch (sm.index)
    {
        ...
        case 3:
            ...
            if ((dma_get_flags(var->dma_rx_id) & DMA_FLAG_BLOCK_TRANSFER_DONE) > 0)
            {
                ...
                {
                    sm.index = 1;   // Fail: incorrect CRC. Retry.
                }
                else
                {
            ...
            {
                sm.index = 1;   // Fail: nothing has been received. Retry.
            }
            break;
...
static uint8_t e_tps92662_write_request(TPS92662_PARAMS *var, TPS92662_INIT_PARAM cde_type, uint8_t device_index, uint8_t address_register, p_tps92662_function p_fct)
{
    ...
    switch (sm.index)
    {
        ...
        case 2:
            ...
            var->dma_tx_params.src_size = 5 + tps92662_init_param_number_of_bytes[cde_type];
            
            dma_clear_flags(var->dma_tx_id, DMA_FLAG_BLOCK_TRANSFER_DONE); 
            dma_set_transfer(var->dma_tx_id, &var->dma_tx_params, true, true);
        ...
        case 3:
            ...
            if ((dma_get_flags(var->dma_tx_id) & DMA_FLAG_BLOCK_TRANSFER_DONE) > 0)
            {
                sm.index = 0;   // End
                dma_clear_flags(var->dma_tx_id, DMA_FLAG_BLOCK_TRANSFER_DONE); 
            }
...
uint8_t e_tps92662_deamon(TPS92662_PARAMS *var)
{
    ...
    if (!var->is_init_done)
    {
        ...
        for (device_index = 0 ; device_index < var->number_of_device ; device_index++)
        {
            ...
            e_tps92662_set_system_config_ptr(var, device_index, TPS92662_SYS_CONF_ACKEN_DISABLE | TPS92662_SYS_CONF_CMWEN_DISABLE | TPS92662_SYS_CONF_SYNCOEN_ENABLE | TPS92662_SYS_CONF_SYNCPEN_50_PERCENT);
            e_tps92662_set_pwm_tick_period_ptr(var, device_index, 0x0f);    // PWM_CLK = 8Mhz / 200 / 19 = 2,105KHz
    ...
    {     
        switch (var->state_machine.index)
        {
            ...
            case SM_TPS92662_READ_IC_IDENTIFIER:
                ...
                if (!e_tps92662_read_request(var, TPS_READ_1B, device_index, TPS92662_ADDR_IC_IDENTIFIER, _get_ic_identifier))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
            ...
            case SM_TPS92662_READ_ERRORS:
                ...
                if (!e_tps92662_read_request(var, TPS_READ_3B, device_index, TPS92662_ADDR_ERRORS, _get_errors))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_READ_ADCS:
                ...
                if (!e_tps92662_read_request(var, TPS_READ_2B, device_index, TPS92662_ADDR_ADC, _get_adc))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_SYSTEM_CONFIG:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_1B, device_index, TPS92662_ADDR_SYSTEM_CONFIG, _set_system_config))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_SLEW_RATE:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_1B, device_index, TPS92662_ADDR_SLEW_RATE, _set_slew_rate))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_OVER_VOLTAGE_LIMIT:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_1B, device_index, TPS92662_ADDR_OVER_VOLTAGE_LIMIT, _set_overvoltage_limit))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_PARALLEL_LED_STRING:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_1B, device_index, TPS92662_ADDR_PARALLEL_LED_STRING, _set_parallel_led_string))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_DEFAULT_PULSE_WIDTH:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_12B, device_index, TPS92662_ADDR_DEFAULT_PULSE_WIDTH, _set_default_pulse_width))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_WATCHDOG_TIMER:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_1B, device_index, TPS92662_ADDR_WATCHDOG_TIMER, _set_watchdog_timer))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_PWM_TICK_PERIOD:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_1B, device_index, TPS92662_ADDR_PWM_TICK_PERIOD, _set_pwm_tick_period))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_ADC_ID:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_1B, device_index, TPS92662_ADDR_ADC_ID, _set_adc_id))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_SOFTSYNC:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_1B, device_index, TPS92662_ADDR_SOFTSYNC, _set_softsync))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_PHASE_AND_WIDTH:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_32B, device_index, TPS92662_ADDR_PHASE, _set_phase_and_width))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_PHASE:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_16B, device_index, TPS92662_ADDR_PHASE, _set_phase))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
            ...
            case SM_TPS92662_WRITE_WIDTH:
                ...
                if (!e_tps92662_write_request(var, TPS_WRITE_16B, device_index, TPS92662_ADDR_WIDTH, _set_width))
                {
                    CLR_BIT(var->p_flags[device_index], var->state_machine.index);
                    var->state_machine.index = SM_TPS92662_HOME;
                }
